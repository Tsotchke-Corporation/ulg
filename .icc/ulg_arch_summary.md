...
- `tests`: 76 files, 48757 lines, symbols=0, tests=76, languages={"text": 76}
...
- `plan/todo`: 24 files, 13641 lines, symbols=0, tests=0, languages={"markdown": 24}
...
- `scripts`: 6 files, 9442 lines, symbols=0, tests=0, languages={"text": 6}
...
- `plan`: 5 files, 52452 lines, symbols=0, tests=0, languages={"markdown": 5}
- `plan/moot`: 5 files, 1771 lines, symbols=0, tests=0, languages={"markdown": 5}
- `src/visualization`: 4 files, 26959 lines, symbols=540, tests=0, languages={"javascript": 4}
...
| Lines | Path | Language |
|---:|---|---|
| 31064 | `plan/log.md` | markdown |
| 20592 | `src/visualization/sphPhaseScene.js` | javascript |
| 13829 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
| 12275 | `plan/tests.md` | markdown |
...
| 6398 | `scripts/sph-long-horizon-probe.mjs` | text |
...
| 5979 | `plan/implementation-status.md` | markdown |
...
| 2972 | `plan/todo/README.md` | markdown |
