...
- `tests`: 75 files, 40931 lines, symbols=0, tests=75, languages={"text": 75}
- `src/runtime`: 31 files, 18176 lines, symbols=399, tests=0, languages={"javascript": 31}
- `src/runtime/sph`: 28 files, 35884 lines, symbols=808, tests=0, languages={"javascript": 28}
- `src/runtime/material`: 19 files, 4884 lines, symbols=212, tests=0, languages={"javascript": 19}
- `plan/todo`: 19 files, 10252 lines, symbols=0, tests=0, languages={"markdown": 19}
...
- `plan`: 5 files, 45174 lines, symbols=0, tests=0, languages={"markdown": 5}
- `plan/moot`: 5 files, 1771 lines, symbols=0, tests=0, languages={"markdown": 5}
- `src/visualization`: 4 files, 17466 lines, symbols=405, tests=0, languages={"javascript": 4}
...
| Lines | Path | Language |
|---:|---|---|
| 26944 | `plan/log.md` | markdown |
| 12415 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
| 11993 | `src/visualization/sphPhaseScene.js` | javascript |
| 9791 | `plan/tests.md` | markdown |
