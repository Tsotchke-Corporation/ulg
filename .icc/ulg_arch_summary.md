...
- `tests`: 75 files, 43227 lines, symbols=0, tests=75, languages={"text": 75}
...
- `plan/todo`: 21 files, 11542 lines, symbols=0, tests=0, languages={"markdown": 21}
...
- `scripts`: 6 files, 7653 lines, symbols=0, tests=0, languages={"text": 6}
...
- `plan`: 5 files, 47601 lines, symbols=0, tests=0, languages={"markdown": 5}
- `plan/moot`: 5 files, 1771 lines, symbols=0, tests=0, languages={"markdown": 5}
- `src/visualization`: 4 files, 20753 lines, symbols=455, tests=0, languages={"javascript": 4}
...
| Lines | Path | Language |
|---:|---|---|
| 28342 | `plan/log.md` | markdown |
| 14983 | `src/visualization/sphPhaseScene.js` | javascript |
| 13291 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
| 10467 | `plan/tests.md` | markdown |
...
| 4924 | `scripts/sph-long-horizon-probe.mjs` | text |
| 3166 | `src/runtime/sphPhaseDemo.js` | javascript |
| 2918 | `tests/sphPhaseRenderer.test.mjs` | text |
| 2833 | `plan/plan.md` | markdown |
| 2386 | `tests/sphRenderGpuKernel.test.mjs` | text |
| 2348 | `plan/todo/README.md` | markdown |
