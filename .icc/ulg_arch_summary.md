...
- `tests`: 76 files, 48819 lines, symbols=0, tests=76, languages={"text": 76}
...
- `plan/todo`: 24 files, 13670 lines, symbols=0, tests=0, languages={"markdown": 24}
...
- `scripts`: 6 files, 9461 lines, symbols=0, tests=0, languages={"text": 6}
...
- `plan`: 5 files, 52643 lines, symbols=0, tests=0, languages={"markdown": 5}
- `plan/moot`: 5 files, 1771 lines, symbols=0, tests=0, languages={"markdown": 5}
- `src/visualization`: 4 files, 27016 lines, symbols=541, tests=0, languages={"javascript": 4}
...
| Lines | Path | Language |
|---:|---|---|
| 31154 | `plan/log.md` | markdown |
| 20649 | `src/visualization/sphPhaseScene.js` | javascript |
| 13829 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
| 12335 | `plan/tests.md` | markdown |
...
| 3001 | `plan/todo/README.md` | markdown |
