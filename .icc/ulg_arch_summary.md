...
- files indexed: `244`
- total lines indexed: `159821`
- languages: `{"javascript": 102, "text": 82, "markdown": 45, "json": 14, "c": 1}`
...
- `tests`: 71 files, 32192 lines, symbols=0, tests=71, languages={"text": 71}
...
- `plan/todo`: 17 files, 9307 lines, symbols=0, tests=0, languages={"markdown": 17}
- `plan/done`: 15 files, 1541 lines, symbols=0, tests=0, languages={"markdown": 15}
...
- `plan`: 5 files, 34353 lines, symbols=0, tests=0, languages={"markdown": 5}
...
| Lines | Path | Language |
|---:|---|---|
| 20938 | `plan/log.md` | markdown |
| 7869 | `src/visualization/sphPhaseScene.js` | javascript |
| 7292 | `plan/tests.md` | markdown |
...
| 4785 | `plan/implementation-status.md` | markdown |
