...
- `tests`: 75 files, 43343 lines, symbols=0, tests=75, languages={"text": 75}
...
- `plan/todo`: 21 files, 11557 lines, symbols=0, tests=0, languages={"markdown": 21}
...
- `scripts`: 6 files, 7670 lines, symbols=0, tests=0, languages={"text": 6}
...
- `plan`: 5 files, 47678 lines, symbols=0, tests=0, languages={"markdown": 5}
- `plan/moot`: 5 files, 1771 lines, symbols=0, tests=0, languages={"markdown": 5}
- `src/visualization`: 4 files, 21061 lines, symbols=456, tests=0, languages={"javascript": 4}
...
| Lines | Path | Language |
|---:|---|---|
| 28385 | `plan/log.md` | markdown |
| 15291 | `src/visualization/sphPhaseScene.js` | javascript |
| 13291 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
| 10501 | `plan/tests.md` | markdown |
...
| 4941 | `scripts/sph-long-horizon-probe.mjs` | text |
| 3166 | `src/runtime/sphPhaseDemo.js` | javascript |
| 3034 | `tests/sphPhaseRenderer.test.mjs` | text |
| 2833 | `plan/plan.md` | markdown |
| 2386 | `tests/sphRenderGpuKernel.test.mjs` | text |
| 2363 | `plan/todo/README.md` | markdown |
