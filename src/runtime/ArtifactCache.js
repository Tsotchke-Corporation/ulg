import { hashPayload, stableStringify } from '../../ulg-gpu-abi/src/index.js';
...
async function hashArtifactPayload(payload) {
...
export class ArtifactCache {
  ...
  async put(artifact) {
    const artifactHash = await hashArtifactPayload(artifact);
    const ref = {
