...
- `tests`: 75 files, 43384 lines, symbols=0, tests=75, languages={"text": 75}
- `src/runtime`: 31 files, 18287 lines, symbols=400, tests=0, languages={"javascript": 31}
- `src/runtime/sph`: 28 files, 38047 lines, symbols=844, tests=0, languages={"javascript": 28}
- `plan/todo`: 21 files, 11621 lines, symbols=0, tests=0, languages={"markdown": 21}
...
- `plan`: 5 files, 47921 lines, symbols=0, tests=0, languages={"markdown": 5}
- `plan/moot`: 5 files, 1771 lines, symbols=0, tests=0, languages={"markdown": 5}
- `src/visualization`: 4 files, 21870 lines, symbols=466, tests=0, languages={"javascript": 4}
...
| Lines | Path | Language |
|---:|---|---|
| 28543 | `plan/log.md` | markdown |
| 16093 | `src/visualization/sphPhaseScene.js` | javascript |
| 13294 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
| 10586 | `plan/tests.md` | markdown |
...
| 2401 | `plan/todo/README.md` | markdown |
...
| 2007 | `src/runtime/sph/sphMarchingCubesSurfaceAdapter.js` | javascript |
