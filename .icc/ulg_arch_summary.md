...
- files indexed: `255`
- total lines indexed: `162450`
- languages: `{"javascript": 103, "text": 83, "markdown": 54, "json": 14, "c": 1}`
...
- `tests`: 72 files, 32708 lines, symbols=0, tests=72, languages={"text": 72}
- `src/runtime`: 30 files, 15660 lines, symbols=353, tests=0, languages={"javascript": 30}
- `src/runtime/sph`: 25 files, 27730 lines, symbols=662, tests=0, languages={"javascript": 25}
- `plan/done`: 24 files, 1826 lines, symbols=0, tests=0, languages={"markdown": 24}
- `src/runtime/material`: 18 files, 4777 lines, symbols=206, tests=0, languages={"javascript": 18}
- `plan/todo`: 17 files, 9499 lines, symbols=0, tests=0, languages={"markdown": 17}
...
- `plan`: 5 files, 35110 lines, symbols=0, tests=0, languages={"markdown": 5}
...
| Lines | Path | Language |
|---:|---|---|
| 21422 | `plan/log.md` | markdown |
| 7869 | `src/visualization/sphPhaseScene.js` | javascript |
| 7633 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
| 7357 | `plan/tests.md` | markdown |
| 7066 | `tests/demo.e2e.mjs` | text |
| 5904 | `ulg-gpu-abi/src/wgsl.js` | javascript |
| 5275 | `src/runtime/sph/sphRenderGpuKernel.js` | javascript |
| 4894 | `plan/implementation-status.md` | markdown |
...
| 1297 | `plan/plan.md` | markdown |
| 1263 | `src/runtime/sph/sphReactionGpuSummary.js` | javascript |
| 1188 | `plan/todo/README.md` | markdown |
