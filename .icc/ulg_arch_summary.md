...
- `tests`: 75 files, 42894 lines, symbols=0, tests=75, languages={"text": 75}
...
- `plan/todo`: 21 files, 11495 lines, symbols=0, tests=0, languages={"markdown": 21}
...
- `plan`: 5 files, 47295 lines, symbols=0, tests=0, languages={"markdown": 5}
- `plan/moot`: 5 files, 1771 lines, symbols=0, tests=0, languages={"markdown": 5}
- `src/visualization`: 4 files, 20124 lines, symbols=447, tests=0, languages={"javascript": 4}
...
| Lines | Path | Language |
|---:|---|---|
| 28164 | `plan/log.md` | markdown |
| 14374 | `src/visualization/sphPhaseScene.js` | javascript |
| 13291 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
| 10359 | `plan/tests.md` | markdown |
| 7972 | `tests/demo.e2e.mjs` | text |
...
| 5799 | `plan/implementation-status.md` | markdown |
...
| 2301 | `plan/todo/README.md` | markdown |
