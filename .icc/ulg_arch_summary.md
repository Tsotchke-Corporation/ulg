...
- `plan/todo`: 24 files, 12887 lines, symbols=0, tests=0, languages={"markdown": 24}
...
- `plan`: 5 files, 51050 lines, symbols=0, tests=0, languages={"markdown": 5}
...
- `data/material-properties`: 1 files, 6950 lines, symbols=0, tests=0, languages={"json": 1}
...
| 2670 | `plan/todo/README.md` | markdown |
