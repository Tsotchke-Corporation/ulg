...
- `plan/todo`: 24 files, 12869 lines, symbols=0, tests=0, languages={"markdown": 24}
...
- `plan`: 5 files, 51035 lines, symbols=0, tests=0, languages={"markdown": 5}
...
- `data/material-properties`: 1 files, 5590 lines, symbols=0, tests=0, languages={"json": 1}
...
| 5590 | `data/material-properties/elements.json` | json |
...
| 2664 | `plan/todo/README.md` | markdown |
