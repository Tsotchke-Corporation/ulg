...
- `tests`: 75 files, 43345 lines, symbols=0, tests=75, languages={"text": 75}
...
- `plan/todo`: 21 files, 11574 lines, symbols=0, tests=0, languages={"markdown": 21}
...
- `scripts`: 6 files, 7691 lines, symbols=0, tests=0, languages={"text": 6}
...
- `plan`: 5 files, 47762 lines, symbols=0, tests=0, languages={"markdown": 5}
- `plan/moot`: 5 files, 1771 lines, symbols=0, tests=0, languages={"markdown": 5}
- `src/visualization`: 4 files, 21353 lines, symbols=458, tests=0, languages={"javascript": 4}
...
| Lines | Path | Language |
|---:|---|---|
| 28435 | `plan/log.md` | markdown |
| 15576 | `src/visualization/sphPhaseScene.js` | javascript |
| 13291 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
| 10535 | `plan/tests.md` | markdown |
