...
- files indexed: `256`
- total lines indexed: `162745`
- languages: `{"javascript": 103, "text": 83, "markdown": 55, "json": 14, "c": 1}`
...
- `tests`: 72 files, 32748 lines, symbols=0, tests=72, languages={"text": 72}
- `src/runtime`: 30 files, 15660 lines, symbols=353, tests=0, languages={"javascript": 30}
- `src/runtime/sph`: 25 files, 27734 lines, symbols=662, tests=0, languages={"javascript": 25}
- `plan/done`: 25 files, 1872 lines, symbols=0, tests=0, languages={"markdown": 25}
- `src/runtime/material`: 18 files, 4777 lines, symbols=206, tests=0, languages={"javascript": 18}
- `plan/todo`: 17 files, 9530 lines, symbols=0, tests=0, languages={"markdown": 17}
...
- `src/services`: 5 files, 1846 lines, symbols=48, tests=0, languages={"javascript": 5}
- `src/runtime/md`: 5 files, 481 lines, symbols=31, tests=0, languages={"javascript": 5}
- `plan`: 5 files, 35195 lines, symbols=0, tests=0, languages={"markdown": 5}
...
| Lines | Path | Language |
|---:|---|---|
| 21468 | `plan/log.md` | markdown |
| 7869 | `src/visualization/sphPhaseScene.js` | javascript |
| 7637 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
| 7367 | `plan/tests.md` | markdown |
| 7106 | `tests/demo.e2e.mjs` | text |
| 5904 | `ulg-gpu-abi/src/wgsl.js` | javascript |
| 5275 | `src/runtime/sph/sphRenderGpuKernel.js` | javascript |
| 4908 | `plan/implementation-status.md` | markdown |
