...
- files indexed: `243`
- total lines indexed: `159553`
- languages: `{"javascript": 102, "text": 82, "markdown": 44, "json": 14, "c": 1}`
...
- `tests`: 71 files, 32148 lines, symbols=0, tests=71, languages={"text": 71}
- `src/runtime`: 30 files, 15489 lines, symbols=350, tests=0, languages={"javascript": 30}
- `src/runtime/sph`: 25 files, 27268 lines, symbols=654, tests=0, languages={"javascript": 25}
- `src/runtime/material`: 18 files, 4777 lines, symbols=206, tests=0, languages={"javascript": 18}
- `plan/todo`: 17 files, 9289 lines, symbols=0, tests=0, languages={"markdown": 17}
- `plan/done`: 14 files, 1518 lines, symbols=0, tests=0, languages={"markdown": 14}
...
- `plan`: 5 files, 34266 lines, symbols=0, tests=0, languages={"markdown": 5}
...
| Lines | Path | Language |
|---:|---|---|
| 20883 | `plan/log.md` | markdown |
| 7869 | `src/visualization/sphPhaseScene.js` | javascript |
| 7287 | `plan/tests.md` | markdown |
| 7171 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
...
| 4772 | `plan/implementation-status.md` | markdown |
| 4420 | `src/runtime/peercomputeBrowserResidentHost.js` | javascript |
| 3835 | `tests/sphMlsMpmGpuStep.test.mjs` | text |
| 3290 | `tests/peercomputeComputeManagerIntegration.test.mjs` | text |
