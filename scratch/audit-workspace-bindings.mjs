...
const ENTRY_TO_PIPELINE = {
  ...
  begin_reflux_coarse_registry: 'beginRegisterReflux',
  claim_reflux_coarse_registry_rows: 'claimRegisterRefluxRows',
  register_reflux_coarse_registry_rows: 'registerRefluxRows',
  seal_reflux_coarse_registry: 'sealRegisterReflux',
  ...
  validate_reflux_coarse_registry_mass_rows: 'validateRegistryRows',
  ...
  begin_coarse_terminal_registry: 'beginRegisterTerminal',
  claim_coarse_terminal_registry_rows: 'claimRegisterTerminalRows',
  register_coarse_terminal_registry_rows: 'registerTerminalRows',
  seal_coarse_terminal_registry: 'sealRegisterTerminal',
