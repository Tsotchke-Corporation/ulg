...
- files indexed: `242`
- total lines indexed: `159267`
- languages: `{"javascript": 102, "text": 82, "markdown": 43, "json": 14, "c": 1}`
...
- `tests`: 71 files, 32115 lines, symbols=0, tests=71, languages={"text": 71}
- `src/runtime`: 30 files, 15489 lines, symbols=350, tests=0, languages={"javascript": 30}
- `src/runtime/sph`: 25 files, 27132 lines, symbols=654, tests=0, languages={"javascript": 25}
- `src/runtime/material`: 18 files, 4777 lines, symbols=206, tests=0, languages={"javascript": 18}
- `plan/todo`: 17 files, 9272 lines, symbols=0, tests=0, languages={"markdown": 17}
- `plan/done`: 13 files, 1495 lines, symbols=0, tests=0, languages={"markdown": 13}
...
- `plan`: 5 files, 34189 lines, symbols=0, tests=0, languages={"markdown": 5}
...
| Lines | Path | Language |
|---:|---|---|
| 20832 | `plan/log.md` | markdown |
| 7869 | `src/visualization/sphPhaseScene.js` | javascript |
| 7284 | `plan/tests.md` | markdown |
| 7035 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
...
| 4760 | `plan/implementation-status.md` | markdown |
| 4420 | `src/runtime/peercomputeBrowserResidentHost.js` | javascript |
| 3835 | `tests/sphMlsMpmGpuStep.test.mjs` | text |
| 3257 | `tests/peercomputeComputeManagerIntegration.test.mjs` | text |
