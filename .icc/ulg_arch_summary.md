...
- `plan/todo`: 24 files, 12997 lines, symbols=0, tests=0, languages={"markdown": 24}
...
- `plan`: 5 files, 51328 lines, symbols=0, tests=0, languages={"markdown": 5}
...
| 2713 | `plan/todo/README.md` | markdown |
