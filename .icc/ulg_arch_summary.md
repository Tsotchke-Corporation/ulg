...
- `plan/todo`: 24 files, 12924 lines, symbols=0, tests=0, languages={"markdown": 24}
...
- `plan`: 5 files, 51076 lines, symbols=0, tests=0, languages={"markdown": 5}
...
| 2682 | `plan/todo/README.md` | markdown |
