...
- `src/runtime/sph`: 28 files, 38031 lines, symbols=844, tests=0, languages={"javascript": 28}
- `plan/todo`: 21 files, 11579 lines, symbols=0, tests=0, languages={"markdown": 21}
...
- `scripts`: 6 files, 7902 lines, symbols=0, tests=0, languages={"text": 6}
...
- `plan`: 5 files, 47850 lines, symbols=0, tests=0, languages={"markdown": 5}
- `plan/moot`: 5 files, 1771 lines, symbols=0, tests=0, languages={"markdown": 5}
- `src/visualization`: 4 files, 21574 lines, symbols=461, tests=0, languages={"javascript": 4}
...
| Lines | Path | Language |
|---:|---|---|
| 28505 | `plan/log.md` | markdown |
| 15797 | `src/visualization/sphPhaseScene.js` | javascript |
| 13294 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
| 10553 | `plan/tests.md` | markdown |
...
| 5173 | `scripts/sph-long-horizon-probe.mjs` | text |
...
| 2385 | `plan/todo/README.md` | markdown |
