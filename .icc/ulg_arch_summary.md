...
- `tests`: 76 files, 48753 lines, symbols=0, tests=76, languages={"text": 76}
- `src/runtime`: 31 files, 19018 lines, symbols=417, tests=0, languages={"javascript": 31}
- `src/runtime/sph`: 28 files, 41573 lines, symbols=908, tests=0, languages={"javascript": 28}
- `plan/todo`: 24 files, 13622 lines, symbols=0, tests=0, languages={"markdown": 24}
...
- `plan`: 5 files, 52370 lines, symbols=0, tests=0, languages={"markdown": 5}
- `plan/moot`: 5 files, 1771 lines, symbols=0, tests=0, languages={"markdown": 5}
- `src/visualization`: 4 files, 26919 lines, symbols=540, tests=0, languages={"javascript": 4}
...
| Lines | Path | Language |
|---:|---|---|
| 31024 | `plan/log.md` | markdown |
| 20568 | `src/visualization/sphPhaseScene.js` | javascript |
| 13812 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
| 12244 | `plan/tests.md` | markdown |
...
| 5998 | `src/visualization/sphPhaseDemoMount.js` | javascript |
| 5968 | `plan/implementation-status.md` | markdown |
...
| 2959 | `plan/todo/README.md` | markdown |
| 2606 | `tests/sphRenderGpuKernel.test.mjs` | text |
| 2562 | `src/runtime/sph/sphReactionGpuKernel.js` | javascript |
