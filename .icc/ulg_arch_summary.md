...
- `tests`: 75 files, 45639 lines, symbols=0, tests=75, languages={"text": 75}
...
- `plan/todo`: 24 files, 12641 lines, symbols=0, tests=0, languages={"markdown": 24}
...
- `plan`: 5 files, 50538 lines, symbols=0, tests=0, languages={"markdown": 5}
...
| 2582 | `plan/todo/README.md` | markdown |
