...
- `tests`: 76 files, 46256 lines, symbols=0, tests=76, languages={"text": 76}
...
- `plan/todo`: 24 files, 12938 lines, symbols=0, tests=0, languages={"markdown": 24}
...
- `plan`: 5 files, 51134 lines, symbols=0, tests=0, languages={"markdown": 5}
...
| 2686 | `plan/todo/README.md` | markdown |
