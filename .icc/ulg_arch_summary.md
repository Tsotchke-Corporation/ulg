...
- `tests`: 75 files, 43137 lines, symbols=0, tests=75, languages={"text": 75}
- `src/runtime`: 31 files, 18287 lines, symbols=400, tests=0, languages={"javascript": 31}
- `src/runtime/sph`: 28 files, 38028 lines, symbols=844, tests=0, languages={"javascript": 28}
- `plan/todo`: 21 files, 11525 lines, symbols=0, tests=0, languages={"markdown": 21}
...
- `scripts`: 6 files, 7624 lines, symbols=0, tests=0, languages={"text": 6}
...
- `plan`: 5 files, 47496 lines, symbols=0, tests=0, languages={"markdown": 5}
- `plan/moot`: 5 files, 1771 lines, symbols=0, tests=0, languages={"markdown": 5}
- `src/visualization`: 4 files, 20564 lines, symbols=453, tests=0, languages={"javascript": 4}
...
| Lines | Path | Language |
|---:|---|---|
| 28281 | `plan/log.md` | markdown |
| 14794 | `src/visualization/sphPhaseScene.js` | javascript |
| 13291 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
| 10423 | `plan/tests.md` | markdown |
| 8045 | `tests/demo.e2e.mjs` | text |
...
| 5417 | `src/visualization/sphPhaseDemoMount.js` | javascript |
| 5087 | `tests/peercomputeComputeManagerIntegration.test.mjs` | text |
| 4895 | `scripts/sph-long-horizon-probe.mjs` | text |
| 3166 | `src/runtime/sphPhaseDemo.js` | javascript |
| 2833 | `plan/plan.md` | markdown |
| 2828 | `tests/sphPhaseRenderer.test.mjs` | text |
| 2386 | `tests/sphRenderGpuKernel.test.mjs` | text |
| 2331 | `plan/todo/README.md` | markdown |
| 2172 | `src/runtime/sph/sphReactionGpuKernel.js` | javascript |
| 2047 | `tests/orchestration.test.mjs` | text |
| 1991 | `src/runtime/sph/sphMarchingCubesSurfaceAdapter.js` | javascript |
