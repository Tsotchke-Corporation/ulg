...
- `plan/todo`: 24 files, 12896 lines, symbols=0, tests=0, languages={"markdown": 24}
...
- `plan`: 5 files, 51058 lines, symbols=0, tests=0, languages={"markdown": 5}
...
- `data/material-properties`: 1 files, 7630 lines, symbols=0, tests=0, languages={"json": 1}
...
| 2673 | `plan/todo/README.md` | markdown |
