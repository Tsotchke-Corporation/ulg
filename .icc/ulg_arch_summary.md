...
- `tests`: 76 files, 46960 lines, symbols=0, tests=76, languages={"text": 76}
...
- `plan/todo`: 24 files, 13039 lines, symbols=0, tests=0, languages={"markdown": 24}
...
| 1472 | `plan/todo/physics-behavior-regression-plan.md` | markdown |
