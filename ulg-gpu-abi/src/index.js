...
export * from './schroederSpatialExactNearCellTree.js';
export * from './schroederSpatialExactNearCellTreeWgsl.js';
...
export * from './sphReactionProductPlacementReceipt.js';
export * from './schroederSpatialTopologyTransition.js';
export * from './schroederSpatialTopologyTransitionWgsl.js';
...
export const ULG_SPH_GPU_REACTION_TABLE_SCHEMA = 'peercompute.ulg.sph-gpu-reaction-table.v1';
export const ULG_REACTION_CLOSURE_SCHEMA = 'peercompute.ulg.reaction-closure.v0';
...
export const ULG_SPH_GPU_RENDER_SURFACE_VERTICES_EXECUTION_SCHEMA = 'peercompute.ulg.sph-gpu-render-surface-vertices-execution.v0';
export const ULG_SPH_GPU_RENDER_SURFACE_DRAW_SCHEMA = 'peercompute.ulg.sph-gpu-render-surface-draw.v0';
export const ULG_SPH_GPU_RENDER_SURFACE_DRAW_EXECUTION_SCHEMA = 'peercompute.ulg.sph-gpu-render-surface-draw-execution.v0';
export const ULG_SPH_GPU_RENDER_SURFACE_DRAW_INDIRECT_SCHEMA = 'peercompute.ulg.sph-gpu-render-surface-draw-indirect.v0';
export const ULG_SPH_MATERIAL_INTERFACE_FIELD_SCHEMA = 'peercompute.ulg.sph-material-interface-field.v0';
export const ULG_SPH_PRESSURE_INTERFACE_COUPLING_SCHEMA = 'peercompute.ulg.sph-pressure-interface-coupling.v0';
export const ULG_SPH_PRESSURE_INTERFACE_FORCE_PREVIEW_SCHEMA = 'peercompute.ulg.sph-pressure-interface-force-preview.v0';
export const ULG_SPH_PRESSURE_INTERFACE_FORCE_SOLVER_SCHEMA = 'peercompute.ulg.sph-pressure-interface-force-solver.v0';
...
export const ULG_SCHROEDER_FAR_AGGREGATE_FORCE_SUMMARY_SCHEMA = 'peercompute.ulg.schroeder-far-aggregate-force-summary.v0';
...
export const ULG_SCHROEDER_PHASE_VOLUME_SPLIT_MERGE_ADMISSION_SCHEMA =
  'peercompute.ulg.schroeder-phase-volume-split-merge-admission.v0';
export const ULG_SCHROEDER_PHASE_VOLUME_SPLIT_MERGE_APPLY_SCHEMA =
  'peercompute.ulg.schroeder-phase-volume-split-merge-apply.v0';
export const ULG_SCHROEDER_PHASE_VOLUME_SPLIT_MERGE_APPLY_EXECUTION_SCHEMA =
  'peercompute.ulg.schroeder-phase-volume-split-merge-apply-execution.v0';
export const ULG_SCHROEDER_PARTICLE_STORAGE_ALLOCATOR_ADMISSION_SCHEMA =
  'peercompute.ulg.schroeder-particle-storage-allocator-admission.v0';
export const ULG_SCHROEDER_PARTICLE_STORAGE_ALLOCATION_SCHEMA =
...
export const SPH_GPU_REACTION_HEADER_ROW_LAYOUT = Object.freeze([
  'reactionIndex:f32',
  ...
  'contactRadiusM:f32',
  'status:f32',
  'primaryProductMaterialId:f32',
  'phaseMaskA:f32',
  'phaseMaskB:f32',
  'atomBalanceStatus:f32',
  'chargeBalanceStatus:f32'
]);
export const SPH_GPU_REACTION_REACTANT_TERM_ROW_LAYOUT = Object.freeze([
  'reactionIndex:f32',
  'materialId:f32',
  'coefficient:f32',
...
export const SPH_GPU_REACTION_PRODUCT_TERM_ROW_LAYOUT = Object.freeze([
  ...
  'materialKeyHash:f32',
  'phaseMask:f32',
  'productPhaseRecordOffset:f32',
  'productPhaseRecordCount:f32',
  'gasSpeciesId:f32',
  'charge:f32',
  'pad0:f32'
]);
export const SPH_GPU_REACTION_GAS_PRODUCT_ROW_LAYOUT = Object.freeze([
  'reactionIndex:f32',
...
export const SPH_GPU_REACTION_ATOM_TERM_ROW_LAYOUT = Object.freeze([
  'reactionIndex:f32',
  'termKindId:f32',
  'termIndex:f32',
  'atomicNumberZ:f32',
...
export const SPH_MATERIAL_INTERFACE_CANDIDATE_ROW_LAYOUT = Object.freeze([
  'surfaceIndex:f32',
  'materialId:f32',
  'phaseId:f32',
  'axisId:f32',
...
export const SPH_GPU_RENDER_SURFACE_VERTEX_ROW_LAYOUT = Object.freeze([
  'surfaceIndex:f32',
  'materialId:f32',
  'phaseId:f32',
  'triangleIndex:f32',
...
export const SPH_GPU_RENDER_SURFACE_DRAW_ROW_LAYOUT = Object.freeze([
  'surfaceIndex:f32',
  'materialId:f32',
  'phaseId:f32',
  'opticalStateId:f32',
...
export const SPH_GPU_RENDER_SURFACE_DRAW_INDIRECT_ROW_LAYOUT = Object.freeze([
  'vertexCount:u32',
  'instanceCount:u32',
  'firstVertex:u32',
  'firstInstance:u32'
]);
export const SPH_PRESSURE_INTERFACE_FORCE_ROW_LAYOUT = Object.freeze([
  'surfaceIndex:f32',
  'materialId:f32',
  'phaseId:f32',
  'axisId:f32',
...
export const MLS_MPM_GPU_GRID_VELOCITY_ROW_LAYOUT = Object.freeze([
  'massKg:f32',
  'velocityXMPerS:f32',
  'velocityYMPerS:f32',
  'velocityZMPerS:f32',
...
export const SCHROEDER_FAR_AGGREGATE_FORCE_SUMMARY_ROW_LAYOUT = Object.freeze([
  'sourceParticleIndex:f32',
  'sourceLevelId:f32',
  'sourceChartId:f32',
  'lawMask:f32',
...
export const SCHROEDER_FAR_AGGREGATE_DIAGNOSTIC_SUMMARY_ROW_LAYOUT = Object.freeze([
  'forceSummaryRowCount:f32',
  'activeSourceCount:f32',
  'emptySourceCount:f32',
  'overflowSourceCount:f32',
  'blockedSourceCount:f32',
  'totalAcceptedCandidateCount:f32',
  'totalActiveCandidateCount:f32',
  'totalOverflowCandidateCount:f32',
  'totalBlockedCandidateCount:f32',
  'maxOpeningRatio:f32',
  'maxFarFieldErrorBound:f32',
  ...
  'totalAggregateMassKg:f32',
  'minDistanceM:f32',
  'maxCandidateBudget:f32',
  'enabledFarLawMask:f32',
  'queueEpoch:f32',
  'stateFamilyId:f32',
  'maxAccelerationSourceParticleIndex:f32',
  'accelerationPressureSourceCount:f32',
  'errorBoundPressureSourceCount:f32',
  'openingRatioPressureSourceCount:f32',
  'overflowPressureRatio:f32',
  'activeCandidatePressureRatio:f32',
  'errorBoundPressureRatio:f32',
  'openingRatioPressureRatio:f32',
  'summaryModeId:f32',
  'status:f32',
  'fullParticleReadbackRequired:f32',
  'stateMutationRequired:f32',
...
export const SCHROEDER_FAR_AGGREGATE_LAW_CONSUMER_ROW_LAYOUT = Object.freeze([
  'sourceParticleIndex:f32',
  'sourceLevelId:f32',
  'sourceChartId:f32',
  'sourceLawMask:f32',
  ...
  'maxOpeningRatio:f32',
  'maxFarFieldErrorBound:f32',
  'accelerationMagnitudeMPerS2:f32',
  'potentialMagnitudeJPerKg:f32',
  'radiationExposureProxy:f32',
  'plasmaCollectiveAccelerationProxy:f32',
  'gasDensityProxyKgPerM3:f32',
  'gasPressureProxyPa:f32',
  'errorPressureFlag:f32',
  'openingPressureFlag:f32',
  'overflowPressureFlag:f32',
...
export const SCHROEDER_CROSS_LEVEL_STATE_DELTA_ROW_LAYOUT = Object.freeze([
  'sourceParticleIndex:f32',
  'childLevelId:f32',
  'parentLevelId:f32',
  'levelDelta:f32',
...
export const ULG_SCHROEDER_PARTICLE_STORAGE_COUNT_SUMMARY_SCHEMA =
  'peercompute.ulg.schroeder-particle-storage-count-summary.v0';
export const ULG_SCHROEDER_PARTICLE_STORAGE_COUNT_SUMMARY_EXECUTION_SCHEMA =
  'peercompute.ulg.schroeder-particle-storage-count-summary-execution.v0';
export const SCHROEDER_PARTICLE_STORAGE_COUNT_SUMMARY_ROW_LAYOUT = Object.freeze([
  'materializationRowCount:f32',
  'admittedRowCount:f32',
  'writtenTargetSlotCount:f32',
  'appendedTargetSlotCount:f32',
  'freedSourceSlotCount:f32',
  'admittedParticleCountDelta:f32',
  'sourceMassKg:f32',
  'targetMassKg:f32',
  'maxMassResidualKg:f32',
  'blockedRowCount:f32',
...
export const SCHROEDER_PHASE_VOLUME_MIGRATION_ROW_LAYOUT = Object.freeze([
  'sourceParticleIndex:f32',
  'sourceLevelId:f32',
  'targetLevelId:f32',
  'status:f32',
  ...
  'aggregateSuppressedDuplicateCount:f32',
  'aggregateMassKg:f32',
  'aggregateRepresentedVolumeM3:f32',
...
export const SCHROEDER_PHASE_VOLUME_SPLIT_MERGE_APPLY_ROW_LAYOUT = Object.freeze([
  'sourceParticleIndex:f32',
  'sourceLevelId:f32',
  'targetLevelId:f32',
  'status:f32',
...
export const SCHROEDER_PARTICLE_STORAGE_ALLOCATION_ROW_LAYOUT = Object.freeze([
  'sourceParticleIndex:f32',
  'sourceLevelId:f32',
  'targetLevelId:f32',
  'status:f32',
  ...
  'targetSlotStartIndex:f32',
  'targetSlotCount:f32',
  'freeSlotStartIndex:f32',
  'freeSlotCount:f32',
  'requiredParticleCapacity:f32',
  'currentParticleCapacity:f32',
...
export const SPH_GPU_REACTION_SUMMARY_ROW_LAYOUT = Object.freeze([
  ...
  'ledgerUnplacedGasProductMassKg:f32',
  'sealedBoxGasProductMoles:f32',
  'reactionHeatJ:f32',
  'ledgerMassResidualKg:f32',
  'ledgerReadyEventCount:f32',
  'ledgerProblemEventCount:f32',
  'proposalMutualPairCount:f32',
  'compactLedgerAvailable:f32'
]);
export const SPH_GPU_REACTION_GAS_SPECIES_SUMMARY_ROW_LAYOUT = Object.freeze([
  'materialId:f32',
  'massKg:f32',
  'moles:f32',
  'visibleMassKg:f32',
...
export const SPH_GPU_REACTION_PRODUCT_INVENTORY_ROW_LAYOUT = Object.freeze([
  'materialId:f32',
  'massKg:f32',
  'visibleMassKg:f32',
  'unplacedMassKg:f32',
...
export const SPH_GPU_REACTION_PRODUCT_EVENT_ROW_LAYOUT = Object.freeze([
  'positionXM:f32',
  'positionYM:f32',
  'positionZM:f32',
  'massKg:f32',
