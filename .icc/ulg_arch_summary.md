...
- `tests`: 75 files, 43712 lines, symbols=0, tests=75, languages={"text": 75}
- `src/runtime`: 31 files, 18287 lines, symbols=400, tests=0, languages={"javascript": 31}
- `src/runtime/sph`: 28 files, 38155 lines, symbols=844, tests=0, languages={"javascript": 28}
- `plan/todo`: 21 files, 11751 lines, symbols=0, tests=0, languages={"markdown": 21}
...
- `plan`: 5 files, 48897 lines, symbols=0, tests=0, languages={"markdown": 5}
