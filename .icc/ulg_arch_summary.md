...
- `tests`: 76 files, 46186 lines, symbols=0, tests=76, languages={"text": 76}
...
- `plan/todo`: 24 files, 12830 lines, symbols=0, tests=0, languages={"markdown": 24}
...
- `plan`: 5 files, 51004 lines, symbols=0, tests=0, languages={"markdown": 5}
...
| 2654 | `plan/todo/README.md` | markdown |
