...
- `tests`: 75 files, 40297 lines, symbols=0, tests=75, languages={"text": 75}
- `src/runtime`: 31 files, 18176 lines, symbols=399, tests=0, languages={"javascript": 31}
- `src/runtime/sph`: 28 files, 34646 lines, symbols=792, tests=0, languages={"javascript": 28}
- `src/runtime/material`: 19 files, 4884 lines, symbols=212, tests=0, languages={"javascript": 19}
- `plan/todo`: 19 files, 10166 lines, symbols=0, tests=0, languages={"markdown": 19}
...
- `plan`: 5 files, 44780 lines, symbols=0, tests=0, languages={"markdown": 5}
- `plan/moot`: 5 files, 1771 lines, symbols=0, tests=0, languages={"markdown": 5}
- `src/visualization`: 4 files, 16469 lines, symbols=392, tests=0, languages={"javascript": 4}
...
| Lines | Path | Language |
|---:|---|---|
| 26645 | `plan/log.md` | markdown |
| 12415 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
| 11055 | `src/visualization/sphPhaseScene.js` | javascript |
| 9696 | `plan/tests.md` | markdown |
| 7611 | `tests/demo.e2e.mjs` | text |
...
| 5061 | `src/visualization/sphPhaseDemoMount.js` | javascript |
| 4329 | `scripts/sph-long-horizon-probe.mjs` | text |
...
| 2095 | `plan/todo/README.md` | markdown |
