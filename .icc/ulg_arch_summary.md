...
- `tests`: 76 files, 45893 lines, symbols=0, tests=76, languages={"text": 76}
...
- `plan/todo`: 24 files, 12694 lines, symbols=0, tests=0, languages={"markdown": 24}
- `src/runtime/material`: 19 files, 5014 lines, symbols=216, tests=0, languages={"javascript": 19}
...
- `plan`: 5 files, 50709 lines, symbols=0, tests=0, languages={"markdown": 5}
...
| 2602 | `plan/todo/README.md` | markdown |
