...
- `tests`: 75 files, 40767 lines, symbols=0, tests=75, languages={"text": 75}
...
- `plan`: 5 files, 44914 lines, symbols=0, tests=0, languages={"markdown": 5}
