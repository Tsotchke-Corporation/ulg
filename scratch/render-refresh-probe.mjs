...
await page.goto(`https://localhost:5173/?scenario=sodium-water&residentGpuTimestampProfile=1&contactCleanupPasses=16&residentInterfaceRefreshMode=disabled&surfaceDraw=off&probeEpoch=${Date.now()}`, { waitUntil: 'load', timeout: 30000 });
