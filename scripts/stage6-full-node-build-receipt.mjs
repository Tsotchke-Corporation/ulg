...
const FULL_NODE_EXPECTED_SKIPS = Object.freeze([
  ...
  Object.freeze({ file: 'tests/schroederIronIceMechanicsDiagnostic.native.test.mjs', name: 'native iron/ice two-level mechanics diagnostic', reason: 'set ULG_RUN_NATIVE_IRON_ICE_MECHANICS_DIAGNOSTIC=1 for native WebGPU', class: 'native-opt-in' }),
