...
- `tests`: 76 files, 45952 lines, symbols=0, tests=76, languages={"text": 76}
- `src/runtime`: 31 files, 18771 lines, symbols=413, tests=0, languages={"javascript": 31}
- `src/runtime/sph`: 28 files, 39069 lines, symbols=860, tests=0, languages={"javascript": 28}
- `plan/todo`: 24 files, 12741 lines, symbols=0, tests=0, languages={"markdown": 24}
- `src/runtime/material`: 20 files, 5018 lines, symbols=216, tests=0, languages={"javascript": 20}
...
- `plan`: 5 files, 50848 lines, symbols=0, tests=0, languages={"markdown": 5}
...
| 3641 | `src/runtime/sphPhaseDemo.js` | javascript |
| 2955 | `plan/plan.md` | markdown |
| 2624 | `plan/todo/README.md` | markdown |
...
| 1815 | `tests/sphPhaseDemo.test.mjs` | text |
