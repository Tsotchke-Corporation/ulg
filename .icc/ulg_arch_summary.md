...
- `tests`: 76 files, 46501 lines, symbols=0, tests=76, languages={"text": 76}
...
- `plan/todo`: 24 files, 13004 lines, symbols=0, tests=0, languages={"markdown": 24}
...
- `scripts`: 6 files, 9307 lines, symbols=0, tests=0, languages={"text": 6}
...
- `plan`: 5 files, 51388 lines, symbols=0, tests=0, languages={"markdown": 5}
- `plan/moot`: 5 files, 1771 lines, symbols=0, tests=0, languages={"markdown": 5}
- `src/visualization`: 4 files, 26205 lines, symbols=528, tests=0, languages={"javascript": 4}
...
| 6263 | `scripts/sph-long-horizon-probe.mjs` | text |
...
| 2720 | `plan/todo/README.md` | markdown |
