...
- `tests`: 75 files, 45777 lines, symbols=0, tests=75, languages={"text": 75}
...
- `plan/todo`: 24 files, 12656 lines, symbols=0, tests=0, languages={"markdown": 24}
...
- `plan`: 5 files, 50574 lines, symbols=0, tests=0, languages={"markdown": 5}
...
| 2584 | `plan/todo/README.md` | markdown |
