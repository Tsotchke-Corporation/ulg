...
- `tests`: 76 files, 48774 lines, symbols=0, tests=76, languages={"text": 76}
...
- `plan/todo`: 24 files, 13656 lines, symbols=0, tests=0, languages={"markdown": 24}
...
- `plan`: 5 files, 52550 lines, symbols=0, tests=0, languages={"markdown": 5}
- `plan/moot`: 5 files, 1771 lines, symbols=0, tests=0, languages={"markdown": 5}
- `src/visualization`: 4 files, 26979 lines, symbols=540, tests=0, languages={"javascript": 4}
...
| Lines | Path | Language |
|---:|---|---|
| 31109 | `plan/log.md` | markdown |
| 20612 | `src/visualization/sphPhaseScene.js` | javascript |
| 13829 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
| 12303 | `plan/tests.md` | markdown |
