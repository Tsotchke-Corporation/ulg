...
- `plan/todo`: 24 files, 12878 lines, symbols=0, tests=0, languages={"markdown": 24}
...
- `plan`: 5 files, 51042 lines, symbols=0, tests=0, languages={"markdown": 5}
...
- `data/material-properties`: 1 files, 6270 lines, symbols=0, tests=0, languages={"json": 1}
...
| 2667 | `plan/todo/README.md` | markdown |
