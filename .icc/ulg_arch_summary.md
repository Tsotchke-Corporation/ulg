...
- `tests`: 75 files, 40870 lines, symbols=0, tests=75, languages={"text": 75}
...
- `plan/todo`: 19 files, 10244 lines, symbols=0, tests=0, languages={"markdown": 19}
...
- `scripts`: 6 files, 6949 lines, symbols=0, tests=0, languages={"text": 6}
...
- `plan`: 5 files, 45099 lines, symbols=0, tests=0, languages={"markdown": 5}
- `plan/moot`: 5 files, 1771 lines, symbols=0, tests=0, languages={"markdown": 5}
- `src/visualization`: 4 files, 16964 lines, symbols=399, tests=0, languages={"javascript": 4}
...
| Lines | Path | Language |
|---:|---|---|
| 26899 | `plan/log.md` | markdown |
| 12415 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
| 11506 | `src/visualization/sphPhaseScene.js` | javascript |
| 9761 | `plan/tests.md` | markdown |
...
| 5105 | `src/visualization/sphPhaseDemoMount.js` | javascript |
| 5087 | `tests/peercomputeComputeManagerIntegration.test.mjs` | text |
| 4345 | `scripts/sph-long-horizon-probe.mjs` | text |
...
| 2023 | `tests/sphPhaseRenderer.test.mjs` | text |
