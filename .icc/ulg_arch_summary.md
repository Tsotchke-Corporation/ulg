...
- `plan/todo`: 24 files, 12807 lines, symbols=0, tests=0, languages={"markdown": 24}
...
- `plan`: 5 files, 50995 lines, symbols=0, tests=0, languages={"markdown": 5}
...
- `data/material-properties`: 1 files, 3550 lines, symbols=0, tests=0, languages={"json": 1}
...
| 3550 | `data/material-properties/elements.json` | json |
| 2955 | `plan/plan.md` | markdown |
| 2648 | `plan/todo/README.md` | markdown |
