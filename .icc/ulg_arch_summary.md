...
- `tests`: 75 files, 43541 lines, symbols=0, tests=75, languages={"text": 75}
- `src/runtime`: 31 files, 18287 lines, symbols=400, tests=0, languages={"javascript": 31}
- `src/runtime/sph`: 28 files, 38124 lines, symbols=844, tests=0, languages={"javascript": 28}
- `plan/todo`: 21 files, 11725 lines, symbols=0, tests=0, languages={"markdown": 21}
...
- `scripts`: 6 files, 8358 lines, symbols=0, tests=0, languages={"text": 6}
...
- `plan`: 5 files, 48622 lines, symbols=0, tests=0, languages={"markdown": 5}
- `plan/moot`: 5 files, 1771 lines, symbols=0, tests=0, languages={"markdown": 5}
- `src/visualization`: 4 files, 24068 lines, symbols=502, tests=0, languages={"javascript": 4}
...
| Lines | Path | Language |
|---:|---|---|
| 28935 | `plan/log.md` | markdown |
| 18063 | `src/visualization/sphPhaseScene.js` | javascript |
| 13294 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
| 10895 | `plan/tests.md` | markdown |
