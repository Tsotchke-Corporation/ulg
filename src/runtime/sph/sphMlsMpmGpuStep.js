...
function createFusedSchroederActiveNodeBinding({
  ...
  if (!schroederActiveNodeList) {
    ...
    return {
      ...
      activeNodeBufferSource: 'dummy-schroeder-active-node-row'
    };
  }
