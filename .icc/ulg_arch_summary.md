...
- `tests`: 75 files, 43424 lines, symbols=0, tests=75, languages={"text": 75}
...
- `plan/todo`: 21 files, 11643 lines, symbols=0, tests=0, languages={"markdown": 21}
...
- `scripts`: 6 files, 7918 lines, symbols=0, tests=0, languages={"text": 6}
...
- `plan`: 5 files, 48005 lines, symbols=0, tests=0, languages={"markdown": 5}
- `plan/moot`: 5 files, 1771 lines, symbols=0, tests=0, languages={"markdown": 5}
- `src/visualization`: 4 files, 21917 lines, symbols=466, tests=0, languages={"javascript": 4}
...
| Lines | Path | Language |
|---:|---|---|
| 28588 | `plan/log.md` | markdown |
| 16127 | `src/visualization/sphPhaseScene.js` | javascript |
| 13294 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
| 10625 | `plan/tests.md` | markdown |
...
| 5437 | `src/visualization/sphPhaseDemoMount.js` | javascript |
| 5189 | `scripts/sph-long-horizon-probe.mjs` | text |
...
| 2415 | `plan/todo/README.md` | markdown |
