...
- files indexed: `257`
- total lines indexed: `163019`
- languages: `{"javascript": 103, "text": 83, "markdown": 56, "json": 14, "c": 1}`
...
- `tests`: 72 files, 32756 lines, symbols=0, tests=72, languages={"text": 72}
- `src/runtime`: 30 files, 15660 lines, symbols=353, tests=0, languages={"javascript": 30}
- `plan/done`: 26 files, 1918 lines, symbols=0, tests=0, languages={"markdown": 26}
- `src/runtime/sph`: 25 files, 27738 lines, symbols=662, tests=0, languages={"javascript": 25}
- `src/runtime/material`: 18 files, 4777 lines, symbols=206, tests=0, languages={"javascript": 18}
- `plan/todo`: 17 files, 9549 lines, symbols=0, tests=0, languages={"markdown": 17}
...
- `plan`: 5 files, 35272 lines, symbols=0, tests=0, languages={"markdown": 5}
...
| 1215 | `plan/todo/README.md` | markdown |
