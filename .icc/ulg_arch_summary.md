...
- `tests`: 75 files, 40645 lines, symbols=0, tests=75, languages={"text": 75}
...
- `plan/todo`: 19 files, 10206 lines, symbols=0, tests=0, languages={"markdown": 19}
...
- `plan`: 5 files, 44850 lines, symbols=0, tests=0, languages={"markdown": 5}
