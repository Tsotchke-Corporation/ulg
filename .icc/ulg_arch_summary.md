...
- `tests`: 71 files, 32081 lines, symbols=0, tests=71, languages={"text": 71}
- `src/runtime`: 30 files, 15489 lines, symbols=350, tests=0, languages={"javascript": 30}
- `src/runtime/sph`: 25 files, 26915 lines, symbols=652, tests=0, languages={"javascript": 25}
- `src/runtime/material`: 18 files, 4777 lines, symbols=206, tests=0, languages={"javascript": 18}
- `plan/todo`: 17 files, 9226 lines, symbols=0, tests=0, languages={"markdown": 17}
...
- `plan`: 5 files, 33985 lines, symbols=0, tests=0, languages={"markdown": 5}
...
| Lines | Path | Language |
|---:|---|---|
| 20710 | `plan/log.md` | markdown |
| 7869 | `src/visualization/sphPhaseScene.js` | javascript |
| 7255 | `plan/tests.md` | markdown |
| 6826 | `tests/demo.e2e.mjs` | text |
| 6818 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
...
| 4732 | `plan/implementation-status.md` | markdown |
