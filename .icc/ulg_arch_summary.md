...
- `plan/todo`: 19 files, 10286 lines, symbols=0, tests=0, languages={"markdown": 19}
...
- `scripts`: 6 files, 7036 lines, symbols=0, tests=0, languages={"text": 6}
...
- `plan`: 5 files, 45422 lines, symbols=0, tests=0, languages={"markdown": 5}
- `plan/moot`: 5 files, 1771 lines, symbols=0, tests=0, languages={"markdown": 5}
- `src/visualization`: 4 files, 17500 lines, symbols=405, tests=0, languages={"javascript": 4}
...
| Lines | Path | Language |
|---:|---|---|
| 27093 | `plan/log.md` | markdown |
| 12513 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
| 12027 | `src/visualization/sphPhaseScene.js` | javascript |
| 9890 | `plan/tests.md` | markdown |
...
| 4432 | `scripts/sph-long-horizon-probe.mjs` | text |
...
| 2118 | `plan/todo/README.md` | markdown |
