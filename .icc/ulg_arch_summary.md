...
- `plan/todo`: 24 files, 12860 lines, symbols=0, tests=0, languages={"markdown": 24}
...
- `plan`: 5 files, 51030 lines, symbols=0, tests=0, languages={"markdown": 5}
...
- `data/material-properties`: 1 files, 5250 lines, symbols=0, tests=0, languages={"json": 1}
...
| 5250 | `data/material-properties/elements.json` | json |
...
| 2661 | `plan/todo/README.md` | markdown |
