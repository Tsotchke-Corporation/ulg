...
- files indexed: `259`
- total lines indexed: `163738`
- languages: `{"javascript": 103, "text": 83, "markdown": 58, "json": 14, "c": 1}`
...
- `tests`: 72 files, 32915 lines, symbols=0, tests=72, languages={"text": 72}
- `src/runtime`: 30 files, 15660 lines, symbols=353, tests=0, languages={"javascript": 30}
- `plan/done`: 28 files, 2002 lines, symbols=0, tests=0, languages={"markdown": 28}
...
- `plan/todo`: 17 files, 9588 lines, symbols=0, tests=0, languages={"markdown": 17}
...
- `plan`: 5 files, 35418 lines, symbols=0, tests=0, languages={"markdown": 5}
...
| 1237 | `plan/todo/README.md` | markdown |
