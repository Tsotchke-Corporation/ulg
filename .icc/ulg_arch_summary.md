...
- files indexed: `248`
- total lines indexed: `160848`
- languages: `{"javascript": 102, "text": 82, "markdown": 49, "json": 14, "c": 1}`
...
- `tests`: 71 files, 32447 lines, symbols=0, tests=71, languages={"text": 71}
- `src/runtime`: 30 files, 15496 lines, symbols=350, tests=0, languages={"javascript": 30}
- `src/runtime/sph`: 25 files, 27508 lines, symbols=657, tests=0, languages={"javascript": 25}
- `plan/done`: 19 files, 1672 lines, symbols=0, tests=0, languages={"markdown": 19}
- `src/runtime/material`: 18 files, 4777 lines, symbols=206, tests=0, languages={"javascript": 18}
- `plan/todo`: 17 files, 9399 lines, symbols=0, tests=0, languages={"markdown": 17}
...
- `plan`: 5 files, 34751 lines, symbols=0, tests=0, languages={"markdown": 5}
...
| Lines | Path | Language |
|---:|---|---|
| 21202 | `plan/log.md` | markdown |
| 7869 | `src/visualization/sphPhaseScene.js` | javascript |
| 7411 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
| 7321 | `plan/tests.md` | markdown |
| 6935 | `tests/demo.e2e.mjs` | text |
| 5904 | `ulg-gpu-abi/src/wgsl.js` | javascript |
| 5275 | `src/runtime/sph/sphRenderGpuKernel.js` | javascript |
| 4840 | `plan/implementation-status.md` | markdown |
| 4811 | `src/visualization/sphPhaseDemoMount.js` | javascript |
| 4427 | `src/runtime/peercomputeBrowserResidentHost.js` | javascript |
...
| 1248 | `plan/plan.md` | markdown |
| 1141 | `src/runtime/sph/sphGridGpuKernel.js` | javascript |
| 1128 | `plan/todo/README.md` | markdown |
