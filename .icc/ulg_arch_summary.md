...
- `tests`: 75 files, 44012 lines, symbols=0, tests=75, languages={"text": 75}
- `src/runtime`: 31 files, 18287 lines, symbols=400, tests=0, languages={"javascript": 31}
- `src/runtime/sph`: 28 files, 38261 lines, symbols=849, tests=0, languages={"javascript": 28}
- `plan/todo`: 21 files, 11816 lines, symbols=0, tests=0, languages={"markdown": 21}
...
- `scripts`: 6 files, 8968 lines, symbols=0, tests=0, languages={"text": 6}
...
- `plan`: 5 files, 49045 lines, symbols=0, tests=0, languages={"markdown": 5}
- `plan/moot`: 5 files, 1771 lines, symbols=0, tests=0, languages={"markdown": 5}
- `src/visualization`: 4 files, 25483 lines, symbols=518, tests=0, languages={"javascript": 4}
...
| Lines | Path | Language |
|---:|---|---|
| 29116 | `plan/log.md` | markdown |
| 19478 | `src/visualization/sphPhaseScene.js` | javascript |
| 13294 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
| 11019 | `plan/tests.md` | markdown |
...
| 5977 | `scripts/sph-long-horizon-probe.mjs` | text |
