...
- `plan/todo`: 21 files, 11667 lines, symbols=0, tests=0, languages={"markdown": 21}
...
- `scripts`: 6 files, 8146 lines, symbols=0, tests=0, languages={"text": 6}
...
- `plan`: 5 files, 48091 lines, symbols=0, tests=0, languages={"markdown": 5}
- `plan/moot`: 5 files, 1771 lines, symbols=0, tests=0, languages={"markdown": 5}
- `src/visualization`: 4 files, 22251 lines, symbols=475, tests=0, languages={"javascript": 4}
...
| Lines | Path | Language |
|---:|---|---|
| 28639 | `plan/log.md` | markdown |
| 16461 | `src/visualization/sphPhaseScene.js` | javascript |
| 13294 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
| 10660 | `plan/tests.md` | markdown |
...
| 5417 | `scripts/sph-long-horizon-probe.mjs` | text |
...
| 2439 | `plan/todo/README.md` | markdown |
