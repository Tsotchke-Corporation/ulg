export const ULG_SCHROEDER_SPATIAL_PARENT_FIELD_MECHANICS_WORKSPACE_SCHEMA =
  'peercompute.ulg.schroeder-spatial-parent-field-mechanics-workspace.v2';

export const SCHROEDER_SPATIAL_PARENT_FIELD_MECHANICS_WORKSPACE_MAGIC = 0x53505732;
export const SCHROEDER_SPATIAL_PARENT_FIELD_MECHANICS_WORKSPACE_VERSION = 2;
...
export const SCHROEDER_SPATIAL_PARENT_FIELD_MECHANICS_WORKSPACE_ROUTE_WORDS = 8;
export const SCHROEDER_SPATIAL_PARENT_FIELD_MECHANICS_WORKSPACE_FINE_IMPULSE_WORDS = 8;
export const SCHROEDER_SPATIAL_PARENT_FIELD_MECHANICS_WORKSPACE_WORKGROUP_SIZE = 64;
export const SCHROEDER_SPATIAL_PARENT_FIELD_MECHANICS_WORKSPACE_PARAMS_BYTES = 256;
...
export const SCHROEDER_SPATIAL_PARENT_FIELD_MECHANICS_WORKSPACE_ABI = Object.freeze({
  ...
  refluxEvidence:
    'keyed-equal-opposite-linear-angular-momentum-and-total-energy-ledger',
...
export function createSchroederSpatialParentFieldMechanicsWorkspaceLayout({
  ...
  const parentToCoarseOrdinalPaddingWords =
    ...
    - unalignedParentToCoarseOrdinalOffsetWords;
  const workspaceContinuationBindingOffsetWords =
    combinedStateOffsetWords
    - (
      combinedStateOffsetWords
      % SCHROEDER_SPATIAL_PARENT_FIELD_MECHANICS_WORKSPACE_BINDING_ALIGNMENT_WORDS
    );
  const workspaceContinuationBindingWordLength =
    parentToCoarseOrdinalOffsetWords
    - workspaceContinuationBindingOffsetWords;
  ...
  return Object.freeze({
    ...
    workspaceHeadBindingWordLength:
      workspaceContinuationBindingOffsetWords,
    workspaceHeadBindingByteLength:
      workspaceContinuationBindingOffsetWords * Uint32Array.BYTES_PER_ELEMENT,
    workspaceContinuationBindingOffsetWords,
    workspaceContinuationBindingByteOffset:
      workspaceContinuationBindingOffsetWords
      * Uint32Array.BYTES_PER_ELEMENT,
    workspaceContinuationBindingWordLength,
