...
- `plan/todo`: 24 files, 12905 lines, symbols=0, tests=0, languages={"markdown": 24}
...
- `plan`: 5 files, 51066 lines, symbols=0, tests=0, languages={"markdown": 5}
...
- `data/material-properties`: 1 files, 8310 lines, symbols=0, tests=0, languages={"json": 1}
...
| 2676 | `plan/todo/README.md` | markdown |
