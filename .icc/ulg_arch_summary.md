...
- `plan/todo`: 21 files, 11517 lines, symbols=0, tests=0, languages={"markdown": 21}
...
- `plan`: 5 files, 47439 lines, symbols=0, tests=0, languages={"markdown": 5}
...
| 2323 | `plan/todo/README.md` | markdown |
