...
- `scripts`: 6 files, 8190 lines, symbols=0, tests=0, languages={"text": 6}
...
- `plan`: 5 files, 48299 lines, symbols=0, tests=0, languages={"markdown": 5}
- `plan/moot`: 5 files, 1771 lines, symbols=0, tests=0, languages={"markdown": 5}
- `src/visualization`: 4 files, 22824 lines, symbols=482, tests=0, languages={"javascript": 4}
...
| Lines | Path | Language |
|---:|---|---|
| 28760 | `plan/log.md` | markdown |
| 17034 | `src/visualization/sphPhaseScene.js` | javascript |
| 13294 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
| 10747 | `plan/tests.md` | markdown |
...
| 5461 | `scripts/sph-long-horizon-probe.mjs` | text |
