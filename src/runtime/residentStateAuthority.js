...
export function buildMlsMpmResidentStepAuthorityLedger({
  ...
  add(RESIDENT_STATE_FAMILIES.MECHANICS, mechanicsOwner, {
    status: nextUsesReactionMechanics
