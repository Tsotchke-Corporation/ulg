...
- files indexed: `247`
- total lines indexed: `160548`
- languages: `{"javascript": 102, "text": 82, "markdown": 48, "json": 14, "c": 1}`
...
- `tests`: 71 files, 32348 lines, symbols=0, tests=71, languages={"text": 71}
- `src/runtime`: 30 files, 15490 lines, symbols=350, tests=0, languages={"javascript": 30}
- `src/runtime/sph`: 25 files, 27463 lines, symbols=656, tests=0, languages={"javascript": 25}
- `src/runtime/material`: 18 files, 4777 lines, symbols=206, tests=0, languages={"javascript": 18}
- `plan/done`: 18 files, 1639 lines, symbols=0, tests=0, languages={"markdown": 18}
- `plan/todo`: 17 files, 9380 lines, symbols=0, tests=0, languages={"markdown": 17}
...
- `plan`: 5 files, 34653 lines, symbols=0, tests=0, languages={"markdown": 5}
...
| 3381 | `tests/peercomputeComputeManagerIntegration.test.mjs` | text |
...
| 1238 | `plan/plan.md` | markdown |
| 1141 | `src/runtime/sph/sphGridGpuKernel.js` | javascript |
| 1118 | `plan/todo/README.md` | markdown |
