...
- files indexed: `262`
- total lines indexed: `164965`
- languages: `{"javascript": 103, "text": 83, "markdown": 61, "json": 14, "c": 1}`
...
- `tests`: 72 files, 33236 lines, symbols=0, tests=72, languages={"text": 72}
- `plan/done`: 31 files, 2148 lines, symbols=0, tests=0, languages={"markdown": 31}
- `src/runtime`: 30 files, 15804 lines, symbols=354, tests=0, languages={"javascript": 30}
- `src/runtime/sph`: 25 files, 28285 lines, symbols=670, tests=0, languages={"javascript": 25}
- `src/runtime/material`: 18 files, 4777 lines, symbols=206, tests=0, languages={"javascript": 18}
- `plan/todo`: 17 files, 9650 lines, symbols=0, tests=0, languages={"markdown": 17}
...
- `plan`: 5 files, 35687 lines, symbols=0, tests=0, languages={"markdown": 5}
...
| Lines | Path | Language |
|---:|---|---|
| 21748 | `plan/log.md` | markdown |
| 8148 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
| 7869 | `src/visualization/sphPhaseScene.js` | javascript |
| 7447 | `plan/tests.md` | markdown |
| 7194 | `tests/demo.e2e.mjs` | text |
| 5904 | `ulg-gpu-abi/src/wgsl.js` | javascript |
| 5275 | `src/runtime/sph/sphRenderGpuKernel.js` | javascript |
| 4971 | `plan/implementation-status.md` | markdown |
| 4811 | `src/visualization/sphPhaseDemoMount.js` | javascript |
| 4735 | `src/runtime/peercomputeBrowserResidentHost.js` | javascript |
| 3925 | `tests/sphMlsMpmGpuStep.test.mjs` | text |
| 3680 | `tests/peercomputeComputeManagerIntegration.test.mjs` | text |
