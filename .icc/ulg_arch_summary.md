...
- files indexed: `263`
- total lines indexed: `165949`
- languages: `{"javascript": 103, "text": 83, "markdown": 62, "json": 14, "c": 1}`
...
- `tests`: 72 files, 33566 lines, symbols=0, tests=72, languages={"text": 72}
- `plan/done`: 32 files, 2185 lines, symbols=0, tests=0, languages={"markdown": 32}
- `src/runtime`: 30 files, 15804 lines, symbols=354, tests=0, languages={"javascript": 30}
- `src/runtime/sph`: 25 files, 28699 lines, symbols=675, tests=0, languages={"javascript": 25}
- `src/runtime/material`: 18 files, 4777 lines, symbols=206, tests=0, languages={"javascript": 18}
- `plan/todo`: 17 files, 9671 lines, symbols=0, tests=0, languages={"markdown": 17}
...
- `src/services`: 5 files, 2067 lines, symbols=53, tests=0, languages={"javascript": 5}
- `src/runtime/md`: 5 files, 481 lines, symbols=31, tests=0, languages={"javascript": 5}
- `plan`: 5 files, 35797 lines, symbols=0, tests=0, languages={"markdown": 5}
...
| 1293 | `plan/todo/README.md` | markdown |
