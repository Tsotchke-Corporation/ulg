...
- files indexed: `258`
- total lines indexed: `163507`
- languages: `{"javascript": 103, "text": 83, "markdown": 57, "json": 14, "c": 1}`
...
- `tests`: 72 files, 32846 lines, symbols=0, tests=72, languages={"text": 72}
- `src/runtime`: 30 files, 15660 lines, symbols=353, tests=0, languages={"javascript": 30}
- `plan/done`: 27 files, 1958 lines, symbols=0, tests=0, languages={"markdown": 27}
- `src/runtime/sph`: 25 files, 28000 lines, symbols=666, tests=0, languages={"javascript": 25}
- `src/runtime/material`: 18 files, 4777 lines, symbols=206, tests=0, languages={"javascript": 18}
- `plan/todo`: 17 files, 9570 lines, symbols=0, tests=0, languages={"markdown": 17}
...
- `src/services`: 5 files, 1966 lines, symbols=52, tests=0, languages={"javascript": 5}
- `src/runtime/md`: 5 files, 481 lines, symbols=31, tests=0, languages={"javascript": 5}
- `plan`: 5 files, 35347 lines, symbols=0, tests=0, languages={"markdown": 5}
...
| 1227 | `plan/todo/README.md` | markdown |
