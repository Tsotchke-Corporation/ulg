...
- `tests`: 75 files, 40837 lines, symbols=0, tests=75, languages={"text": 75}
...
- `plan/todo`: 19 files, 10238 lines, symbols=0, tests=0, languages={"markdown": 19}
...
- `scripts`: 6 files, 6923 lines, symbols=0, tests=0, languages={"text": 6}
...
- `plan`: 5 files, 45031 lines, symbols=0, tests=0, languages={"markdown": 5}
- `plan/moot`: 5 files, 1771 lines, symbols=0, tests=0, languages={"markdown": 5}
- `src/visualization`: 4 files, 16864 lines, symbols=398, tests=0, languages={"javascript": 4}
...
| Lines | Path | Language |
|---:|---|---|
| 26859 | `plan/log.md` | markdown |
| 12415 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
| 11406 | `src/visualization/sphPhaseScene.js` | javascript |
| 9733 | `plan/tests.md` | markdown |
...
| 4335 | `scripts/sph-long-horizon-probe.mjs` | text |
