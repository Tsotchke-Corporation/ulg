...
- `plan/todo`: 19 files, 10255 lines, symbols=0, tests=0, languages={"markdown": 19}
...
- `plan`: 5 files, 45190 lines, symbols=0, tests=0, languages={"markdown": 5}
