...
- `tests`: 75 files, 42930 lines, symbols=0, tests=75, languages={"text": 75}
...
- `plan/todo`: 21 files, 11506 lines, symbols=0, tests=0, languages={"markdown": 21}
...
- `plan`: 5 files, 47377 lines, symbols=0, tests=0, languages={"markdown": 5}
- `plan/moot`: 5 files, 1771 lines, symbols=0, tests=0, languages={"markdown": 5}
- `src/visualization`: 4 files, 20156 lines, symbols=447, tests=0, languages={"javascript": 4}
...
| Lines | Path | Language |
|---:|---|---|
| 28203 | `plan/log.md` | markdown |
| 14388 | `src/visualization/sphPhaseScene.js` | javascript |
| 13291 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
| 10382 | `plan/tests.md` | markdown |
| 8008 | `tests/demo.e2e.mjs` | text |
...
| 5415 | `src/visualization/sphPhaseDemoMount.js` | javascript |
...
| 2312 | `plan/todo/README.md` | markdown |
