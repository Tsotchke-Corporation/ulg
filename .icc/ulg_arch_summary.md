...
- `plan/todo`: 24 files, 12815 lines, symbols=0, tests=0, languages={"markdown": 24}
...
- `plan`: 5 files, 50999 lines, symbols=0, tests=0, languages={"markdown": 5}
...
- `data/material-properties`: 1 files, 4230 lines, symbols=0, tests=0, languages={"json": 1}
