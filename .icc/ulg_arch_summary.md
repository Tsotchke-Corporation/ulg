...
- `tests`: 75 files, 43455 lines, symbols=0, tests=75, languages={"text": 75}
...
- `scripts`: 6 files, 8327 lines, symbols=0, tests=0, languages={"text": 6}
...
- `plan`: 5 files, 48377 lines, symbols=0, tests=0, languages={"markdown": 5}
- `plan/moot`: 5 files, 1771 lines, symbols=0, tests=0, languages={"markdown": 5}
- `src/visualization`: 4 files, 23761 lines, symbols=494, tests=0, languages={"javascript": 4}
...
| Lines | Path | Language |
|---:|---|---|
| 28802 | `plan/log.md` | markdown |
| 17971 | `src/visualization/sphPhaseScene.js` | javascript |
| 13294 | `src/runtime/sph/sphMlsMpmGpuStep.js` | javascript |
| 10783 | `plan/tests.md` | markdown |
...
| 5598 | `scripts/sph-long-horizon-probe.mjs` | text |
...
| 3059 | `tests/sphPhaseRenderer.test.mjs` | text |
