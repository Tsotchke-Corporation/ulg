...
- files indexed: `279`
- total lines indexed: `173554`
- languages: `{"javascript": 104, "text": 84, "markdown": 76, "json": 14, "c": 1}`
...
- `tests`: 73 files, 35309 lines, symbols=0, tests=73, languages={"text": 73}
- `plan/done`: 46 files, 2902 lines, symbols=0, tests=0, languages={"markdown": 46}
- `src/runtime`: 30 files, 16494 lines, symbols=360, tests=0, languages={"javascript": 30}
- `src/runtime/sph`: 26 files, 30626 lines, symbols=705, tests=0, languages={"javascript": 26}
- `src/runtime/material`: 18 files, 4777 lines, symbols=206, tests=0, languages={"javascript": 18}
- `plan/todo`: 17 files, 9861 lines, symbols=0, tests=0, languages={"markdown": 17}
...
- `plan`: 5 files, 37775 lines, symbols=0, tests=0, languages={"markdown": 5}
...
| 1595 | `plan/plan.md` | markdown |
| 1476 | `plan/todo/README.md` | markdown |
