...
- `tests`: 75 files, 43881 lines, symbols=0, tests=75, languages={"text": 75}
- `src/runtime`: 31 files, 18287 lines, symbols=400, tests=0, languages={"javascript": 31}
- `src/runtime/sph`: 28 files, 38189 lines, symbols=846, tests=0, languages={"javascript": 28}
- `plan/todo`: 21 files, 11799 lines, symbols=0, tests=0, languages={"markdown": 21}
...
- `scripts`: 6 files, 8955 lines, symbols=0, tests=0, languages={"text": 6}
...
- `plan`: 5 files, 48955 lines, symbols=0, tests=0, languages={"markdown": 5}
- `plan/moot`: 5 files, 1771 lines, symbols=0, tests=0, languages={"markdown": 5}
- `src/visualization`: 4 files, 25322 lines, symbols=517, tests=0, languages={"javascript": 4}
...
| 19317 | `src/visualization/sphPhaseScene.js` | javascript |
...
| 5968 | `scripts/sph-long-horizon-probe.mjs` | text |
