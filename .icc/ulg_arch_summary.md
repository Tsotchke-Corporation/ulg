...
- `tests`: 75 files, 43824 lines, symbols=0, tests=75, languages={"text": 75}
...
- `plan/todo`: 21 files, 11783 lines, symbols=0, tests=0, languages={"markdown": 21}
...
- `scripts`: 6 files, 8921 lines, symbols=0, tests=0, languages={"text": 6}
...
- `plan`: 5 files, 48936 lines, symbols=0, tests=0, languages={"markdown": 5}
- `plan/moot`: 5 files, 1771 lines, symbols=0, tests=0, languages={"markdown": 5}
- `src/visualization`: 4 files, 25126 lines, symbols=515, tests=0, languages={"javascript": 4}
...
| 19121 | `src/visualization/sphPhaseScene.js` | javascript |
...
| 5958 | `scripts/sph-long-horizon-probe.mjs` | text |
