...
- `tests`: 76 files, 45804 lines, symbols=0, tests=76, languages={"text": 76}
...
- `plan/todo`: 24 files, 12660 lines, symbols=0, tests=0, languages={"markdown": 24}
...
- `plan`: 5 files, 50612 lines, symbols=0, tests=0, languages={"markdown": 5}
...
| 2586 | `plan/todo/README.md` | markdown |
